...
def main():
    ...
    history = model.fit(train_ds, epochs=200, steps_per_epoch=train_steps, use_multiprocessing=True, validation_data=validate_ds, validation_steps=32)
    results = model.evaluate(validate_ds, batch_size=None, steps=256)
    print(history.history)
    print(results)
    model.save("./fullkeyboardboth2.h5", include_optimizer=True)
